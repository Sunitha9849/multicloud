...
resource "aws_instance" "web1" {
 ...
 connection {
    type     = "ssh"
    user     = "ec2-user"
    private_key = file("C:/Users/sunitha/OneDrive/aws/mykey123.pem")
...
resource "null_resource" "image" {
  provisioner "local-exec" {
    command = "git clone https://github.com/Sunitha9849/multicloud.git images"
  }
}
...
provisioner "remote-exec" {
    inline = [
      ...
      "sudo git clone https://github.com/Sunitha9849/multicloud.git /var/www/html/",
      "sudo su << EOF",
